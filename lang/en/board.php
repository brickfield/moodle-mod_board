...
$string['settings_heading_logging_info'] = 'By default the logging does not contain eg the text of a note or comments, ... .<br>Pay attention to dataprivacy! If needed and allowed then you can activate to add information that where entered by the users to the log.';
$string['addcommenttolog'] = 'Add comment to log';
$string['addcommenttolog_desc'] = '';
$string['addcolumnnametolog'] = 'Add column name to log';
$string['addcolumnnametolog_desc'] = '';
$string['addnotetolog'] = 'Add note to log';
$string['addnotetolog_desc'] = '';
$string['addheadingtolog'] = 'Add heading to log';
$string['addheadingtolog_desc'] = '';
$string['addattachmenttolog'] = 'Add attachment to log';
$string['addattachmenttolog_desc'] = '';
$string['addratingtolog'] = 'Add rating to log';
$string['addratingtolog_desc'] = '';
