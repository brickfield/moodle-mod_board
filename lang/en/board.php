...
$string['allowpeertube'] = 'Allow peertube';
$string['allowpeertube_desc'] = 'If activated a button to add an embeded Peertube Video is supported.';
$string['allowpod'] = 'Allow pod';
$string['allowpod_desc'] = 'If activated a button to add an embeded Pod Video is supported.';
$string['whitelistpeertube'] = 'Whitelist for peertube embedding';
$string['whitelistpeertube_desc'] = 'Only peertube videos with an url belonging to this list can be embedded. Add one url per line.';
$string['whitelistpod'] = 'Whitelist for pod embedding';
$string['whitelistpod_desc'] = 'Only pod videos with an url belonging to  this list can be embedded. Add one url per line.';
$string['option_peertube'] = 'Video (PeerTube)';
$string['option_peertube_info'] = 'Video title';
$string['option_peertube_url'] = 'Peertube URL';
$string['option_pod'] = 'Video (Pod)';
$string['option_pod_info'] = 'Video title';
$string['option_pod_url'] = 'Pod URL';
$string['invalid_peertube_url'] = 'Invalid PeerTube URL';
$string['invalid_pod_url'] = 'Invalid Pod URL';
$string['not_whitelisted_peertube_url'] = 'This PeerTube URL is not whitelisted';
$string['not_whitelisted_pod_url'] = 'This Pod URL is not whitelisted';