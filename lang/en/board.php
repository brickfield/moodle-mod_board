...
$string['remove_note_title'] = 'Delete post';
$string['remove_note_text'] = 'This will affect all other users as well.<br/>Are you sure you want to delete this post?';
$string['rate_note_text'] = 'Are you sure you want to rate this post?';
$string['remove_column_title'] = 'Delete column';
$string['remove_column_text'] = 'All the posts for this column will be deleted along with the column itself.<br/>Are you sure you want to continue?';
$string['note_changed_title'] = 'Post changed.';
$string['note_changed_text'] = "The post you are editing has changed.<br/>Press 'OK' to see the updated post or 'Cancel' to continue editing.";
