...
$string['board:managenotes'] = 'Manage all posts: move, edit and delete posts created by other users.';
...
$string['enableblanktarget_desc'] = 'If being embedded, links need to open into a new window, outside the iframe, otherwise this should be disabled.';
$string['enableblanktarget_help'] = 'When enabled all links will open in a new tab/window.';
$string['enableblanktargetrequired'] = 'Must be enabled if board is embedded.';
