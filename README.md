...
* Optional private and public Single user modes.
* Standard Moodle group access settings (when Single user mode is disabled).
...
## Version support ##
This plugin has been developed to work on Moodle 4.5 and 5.0 releases.
