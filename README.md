...
## What is Board?
Encourage lively discussions and thought-sharing with Board, a post-it board activity for students!

This is an anonymous collaborative activity, with teacher-editable columns, where students can add their contributions, of text, images, URLs and videos, as a collection of visual posts.

Commenting on posts is enabled by default via capabilities, and rating posts can be enabled or disabled in each board instance’s settings.

## License
2023 Onward [Brickfield Education Labs](https://www.brickfield.ie)

## Version support
This plugin has been developed to work on Moodle release 4.4, with other branches supporting other releases of Moodle.
...
### Icon design
Many thanks to [Stuart Lamour](https://github.com/stuartlamour) for our new board icon! Also thanks to [Luca Bosch](https://github.com/lucaboesch) for our updated 4.4 icon!
