...
Feature: Usage of mod_board in public single user mode
  ...
  Scenario: Teachers and owners may post, everybody can read read mod_board posts in public single user mode and no group mode
    ...
    And I click on "Post" "button" in the "New post for column First Column" "dialogue"
    Then I should see "Title in Student 1" in the "1" "mod_board > column"
    And I should see "Title Own Student 1" in the "1" "mod_board > column"
    And I should not see "Title Own Teacher" in the "1" "mod_board > column"

    When I select "First Teacher" from the "Select user" singleselect
    And "Add new post to column First Column" "mod_board > button" should not be visible
    Then I should not see "Title in Student 1" in the "1" "mod_board > column"
    And I should not see "Title Own Student 1" in the "1" "mod_board > column"
    And I should see "Title Own Teacher" in the "1" "mod_board > column"

    When I select "Second Student" from the "Select user" singleselect
    And "Add new post to column First Column" "mod_board > button" should not be visible
    Then I should not see "Title in Student 1" in the "1" "mod_board > column"
    And I should not see "Title Own Student 1" in the "1" "mod_board > column"
    And I should not see "Title Own Teacher" in the "1" "mod_board > column"
  ...
  Scenario: Everybody may filter users by group in mod_board in public single user mode with visible group mode
    Given the following "activity" exists:
      | activity       | board                  |
      | course         | C1                     |
      | name           | Sample board           |
    ...
    And the following fields match these values:
      | Visible groups | Group B       |
      | Select user    | Second Student |
    And "Add new post to column First Column" "mod_board > button" should be visible
    And I click on "Add new post to column First Column" "mod_board > button" in the "1" "mod_board > column"
    And I set the following fields to these values:
    ...
    And I select "First Teacher" from the "Select user" singleselect
    And "Add new post to column First Column" "mod_board > button" should not be visible
    ...
    And the "Select user" select box should contain "Second Student"
    And the "Select user" select box should not contain "First Student"
  ...
  Scenario: Everybody may filter users in own groups in mod_board in public single user mode with separate group mode
    Given the following "activity" exists:
      | activity       | board                  |
      | course         | C1                     |
      | name           | Sample board           |
    ...
    When I am on the "Sample board" "board activity" page logged in as "student2"
    And I should see "Separate groups: Group B"
    And the following fields match these values:
      | Select user    | Second Student |
    And "Add new post to column First Column" "mod_board > button" should be visible
    And I click on "Add new post to column First Column" "mod_board > button" in the "1" "mod_board > column"
    ...
    And the "Select user" select box should contain "Third Student"
    And the "Select user" select box should not contain "First Teacher"
    And I select "Third Student" from the "Select user" singleselect
