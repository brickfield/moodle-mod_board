...
/**
 * Test update_note event.
 *
 * @package    mod_board
 * @copyright  2025 Brickfield Education Labs <https://www.brickfield.ie/>
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers     \mod_board\event\update_note
 */
final class update_note_test extends \advanced_testcase {
    public function test_event(): void {
        ...
        $event = $events[0];
        $this->assertInstanceOf(\mod_board\event\update_note::class, $event);
        ...
        $this->assertSame('Post updated', $event->get_name());
        ...
        $sink = $this->redirectEvents();
        note::update($note->id, 'NH 1c', 'NC 1c', []);
        $events = $sink->get_events();
        $sink->close();
        $this->assertCount(1, $events);
        $event = $events[0];
