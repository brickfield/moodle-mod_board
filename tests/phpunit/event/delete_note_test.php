...
/**
 * Test delete_note event.
 *
 * @package    mod_board
 * @copyright  2025 Brickfield Education Labs <https://www.brickfield.ie/>
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers     \mod_board\event\delete_note
 */
final class delete_note_test extends \advanced_testcase {
    public function test_event(): void {
        ...
        $event = $events[0];
        $this->assertInstanceOf(\mod_board\event\delete_note::class, $event);
        ...
        $this->assertSame('Post deleted', $event->get_name());
