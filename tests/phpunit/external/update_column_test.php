...
use mod_board\external\update_column;
use mod_board\board;

/**
 * Test external method for updating of columns.
 *
 * @package    mod_board
 * @copyright  2025 Brickfield Education Labs <https://www.brickfield.ie/>
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers     \mod_board\external\update_column
 */
final class update_column_test extends \advanced_testcase {
    public function test_execute(): void {
        ...
        $result = update_column::execute($column4->id, 'Col Y');
        $result = update_column::clean_returnvalue(update_column::execute_returns(), $result);
        ...
        try {
            update_column::execute($column4->id, 'Col Z');
