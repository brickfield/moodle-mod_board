...
use mod_board\external\add_column;
use mod_board\board;

/**
 * Test external method for adding of columns.
 *
 * @package    mod_board
 * @copyright  2025 Brickfield Education Labs <https://www.brickfield.ie/>
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers     \mod_board\external\add_column
 */
final class add_column_test extends \advanced_testcase {
    public function test_execute(): void {
        ...
        $result = add_column::execute($board1->id, 'Col X');
        $result = add_column::clean_returnvalue(add_column::execute_returns(), $result);
        ...
        try {
            add_column::execute($board1->id, 'Col Y');
